...
package.skeleton("BSEHydroModels", list=c("soil_wetting_above_capacity", "soilwetting", "soildrying", "TMWB_Model", "CN_Model"))
install.packages("BSEHydroModels", repos=NULL)


#git config --global user.email "cwatt17@vt.edu"
#git config --global user.name "Christina Watt"
